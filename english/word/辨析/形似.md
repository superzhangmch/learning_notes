### crack wreak wreck wretch wretched racket cricket
...
- wreak /riːk/ 造成，带来（尤指严重破坏、痛苦）- inflict
...
### allude elude elusive evasive illude delude prelude
...
- evasive /ɪˈveɪsɪv/ 回避的；闪烁其词的 - avoiding direct answer
  - He gave an evasive reply when asked about the money.
...
### preclude prelude
- preclude /prɪˈkluːd/ 排除；阻止 - prevent
  * Lack of evidence precluded further action.
- prelude /ˈpreljuːd/ 前奏；序幕 - introduction
...
### resurgence insurgent insurgence insurrect
- resurgence /rɪˈsɜːrdʒəns/ 复兴、再现 (revival)
  - There has been a resurgence of interest in jazz music.
- insurgent /ɪnˈsɜːrdʒənt/ 叛乱者；叛乱的 - rebel
  - Government forces battled insurgents in the north.
- insurgence /ɪnˈsɜːrdʒəns/ 叛乱、起义 (rebellion)
  - The government struggled to suppress the insurgence.
- insurrect /ˌɪnsəˈrekt/ 起义，反抗（较少用） - rise in revolt
  - The group tried to insurrect against the regime.
...
### scrub scratch scrap scrape
- scrub /skrʌb/ 擦洗，来回用力刷洗 - clean hard
...
### conspicuous suspicious conspiracy
- conspicuous /kənˈspɪkjuəs/ 显眼的、引人注目的 (noticeable)
  - Her red dress made her conspicuous at the party.
- suspicious /səˈspɪʃəs/ 可疑的；怀疑的 (doubtful / distrustful)
  - His sudden change of attitude made everyone suspicious.
...
### sob sober slumber plumber lumber
- sob /sɒb/ 呜咽；啜泣 - cry noisily
  - She began to sob after hearing the bad news.
- sober /ˈsəʊbər/ 清醒的；冷静的；素净的 - not drunk / serious
...
- oblivious /əˈblɪvɪəs/ 不知情的；忘却的, 浑然不觉的 - unaware
  - She was oblivious to the danger.
- 注意二者意思有点相反. 一个是明显, 一个是浑然不觉的(不明显)
...
### naughty nasty haste
- naughty /ˈnɔːti/ 淘气的；不听话的 - misbehaving
  * The naughty child hid under the table.
- nasty /ˈnɑːsti/ 恶劣的；令人不快的 - unpleasant
  * The food had a nasty smell.
- haste /heɪst/ 匆忙；急忙 - hurry
...
### noxious toxic exotic erotic
- noxious /ˈnɒkʃəs/ 有害的；有毒的（尤指气体、烟雾、影响） - harmful
  - Noxious fumes filled the tunnel after the fire.
- toxic /ˈtɒksɪk/ 有毒的；有害的（也可指关系、环境等） - poisonous
  - The factory dumped toxic waste into the river.
- exotic /ɪɡˈzɒtɪk/ 异国的；奇异的 - foreign / unusual
  - The market sells exotic fruits from Southeast Asia.
- erotic /ɪˈrɒtɪk/ 色情的；性爱的 - sexual
  - The novel contains some erotic imagery.

### stern sturdy stubborn
- stern /stɜːrn/ 严厉的；冷峻的 - severe
  - Her father gave her a stern warning.
- sturdy /ˈstɜːrdi/ 结实的；坚固的 - strong
  - The table is sturdy enough to hold the machine.
- stubborn /ˈstʌbərn/ 固执的；顽强的 - obstinate
  - He is too stubborn to admit that he was wrong.

### spout sprout
- spout /spaʊt/ 喷出；壶嘴；喷口 - gush / nozzle
  - Water spouted from the broken pipe.
- sprout /spraʊt/ 发芽；嫩芽 - grow / shoot
  - The seeds began to sprout after a few days.

### manifest manifesto manifold
- manifest /ˈmænɪfest/ 明显的；显现；表明 - obvious / show clearly
  - Her disappointment was manifest on her face.
- manifesto /ˌmænɪˈfestoʊ/ 宣言；声明 - declaration
  - The party published a manifesto before the election.
- manifold /ˈmænɪfoʊld/ 多种多样的；多方面的 - many and varied
  - The job offers manifold opportunities for growth.

### cleric clergy clerk
- cleric /ˈklerɪk/ 神职人员；牧师 - member of the clergy
  - The old cleric spoke to the crowd after the service.
- clergy /ˈklɜːrdʒi/ 神职人员总称 - priests and ministers as a group
  - Members of the clergy attended the ceremony.
- clerk /klɜːrk/ 店员；办事员；书记员 - office worker
  - The clerk checked my passport at the counter.

### stow stew steward
- stow /stəʊ/ 收装；装载并放好 - pack away
  - Please stow your bag under the seat.
- stew /stjuː/ 炖菜；炖；闷闷不乐 - slow-cooked dish / worry
  - She made a beef stew for dinner.
- steward /ˈstjuːərd/ 管家；乘务员；管理员 - attendant / manager
  - A flight steward helped the passenger find her seat.

### hatch latch
- hatch /hætʃ/ 孵化；舱口；策划 - emerge / opening
  - The chicks hatched this morning.
- latch /lætʃ/ 门闩；用门闩锁住 - fastening
  - He lifted the latch and pushed the gate open.

### stalk stall stake
- stalk /stɔːk/ 茎；悄悄跟踪；高视阔步地走 - stem / follow secretly
  - The tiger stalked its prey through the grass.
- stall /stɔːl/ 摊位；使停止；拖延 - booth / stop
  - The engine stalled in the middle of the road.
- stake /steɪk/ 木桩；赌注；利害关系 - post / risk
  - They drove a stake into the ground.

### mundane mandate
- mundane /mʌnˈdeɪn/ 平凡的；世俗的 - ordinary
  - Most of his work involves mundane office tasks.
- mandate /ˈmændeɪt/ 授权；命令；强制令 - official order
  - The new law gives the agency a clear mandate.

### owe own
- owe /əʊ/ 欠；应归功于 - be in debt / be due to
  - I owe him twenty dollars.
- own /əʊn/ 自己的；拥有 - possess
  - She owns a small bookstore downtown.

### charisma enigma
- charisma /kəˈrɪzmə/ 魅力；感召力 - personal magnetism
  - The speaker's charisma won over the audience.
- enigma /ɪˈnɪɡmə/ 谜；神秘莫测的人或事 - mystery
  - The disappearance remains an enigma.

### poise pose poison
- poise /pɔɪz/ 镇定；优雅；使平衡 - composure / balance
  - She answered the difficult questions with poise.
- pose /pəʊz/ 摆姿势；造成；提出 - position / present
  - The reporter posed a direct question.
- poison /ˈpɔɪzən/ 毒药；毒害 - toxin
  - Some mushrooms contain deadly poison.

### margarine migraine
- margarine /ˌmɑːrdʒəˈriːn/ 人造黄油 - butter substitute
  - He spread margarine on the toast.
- migraine /ˈmaɪɡreɪn/ 偏头痛 - severe headache
  - Bright light can trigger a migraine.

### dagger dipper
- dagger /ˈdæɡər/ 匕首 - short knife
  - The guard carried a dagger at his belt.
- dipper /ˈdɪpər/ 杓子；北斗七星中的斗形部分 - ladle / constellation part
  - She used a dipper to scoop water from the bucket.

### bacon beacon
- bacon /ˈbeɪkən/ 培根 - cured pork
  - We had eggs and bacon for breakfast.
- beacon /ˈbiːkən/ 灯塔；信号灯；指路明灯 - signal light
  - A flashing beacon warned ships away from the rocks.

### crawl creep
- crawl /krɔːl/ 爬行；缓慢行进 - move slowly on hands and knees
  - Traffic crawled along the highway.
- creep /kriːp/ 蹑手蹑脚地移动；慢慢蔓延 - move quietly / spread slowly
  - He crept into the room without making a sound.

### insulate isolate
- insulate /ˈɪnsjuleɪt/ 使绝缘；隔热；隔音 - protect from heat, sound, or electricity
  - Thick walls help insulate the house against cold.
- isolate /ˈaɪsəleɪt/ 使隔离；使孤立；把……分开 - separate from others
  - The infected patients were isolated from the rest of the ward.

### notch nudge
- notch /nɒtʃ/ 刻痕；凹口；把……提高一点 - cut / groove
  - There was a small notch on the edge of the blade.
- nudge /nʌdʒ/ 轻推；轻轻推动 - push gently
  - She nudged me to get my attention.

### maximum maximal
- maximum /ˈmæksɪməm/ 最大值；最大的 - greatest possible amount
  - The hall has a maximum capacity of 500 people.
- maximal /ˈmæksɪməl/ 最大的；尽可能多的 - to the highest degree
  - The treatment produced a maximal response.

### airport airfield
- airport /ˈeəpɔːrt/ 机场（通常较大，有航站楼和民航服务） - passenger airport
  - We arrived at the airport two hours early.
- airfield /ˈeəfiːld/ 飞机场；飞机起降场 - landing field
  - The old military airfield is now closed.

### apprehend apprehension apprehensive reprehend reprehensible comprehend comprehension
- apprehend /ˌæprɪˈhend/ 逮捕；理解；忧虑地意识到 - arrest / understand
  - The police apprehended the suspect near the station.
  - I fail to apprehend his meaning.
- apprehension /ˌæprɪˈhenʃn/ 忧虑，恐惧；逮捕，拘押；理解，领悟 - anxiety / arrest / understanding
  - She felt great apprehension before the interview.
- apprehensive /ˌæprɪˈhensɪv/ 担心的；焦虑的 - anxious
  - He was apprehensive about the results.
- reprehend /ˌreprɪˈhend/ 谴责；斥责 - blame
  - The committee reprehended the official for misconduct.
- reprehensible /ˌreprɪˈhensəbl/ 应受谴责的 - deserving blame
  - The report described the behavior as reprehensible.
- comprehend /ˌkɒmprɪˈhend/ 理解，领会 - understand fully
  - Young children may not comprehend abstract ideas.
- comprehension /ˌkɒmprɪˈhenʃn/ 理解；理解力 - understanding
  - Reading comprehension improves with practice.

### canon cannon
- canon /ˈkænən/ 教规；经典作品；正典 - rule / accepted works
  - Shakespeare is central to the English literary canon.
- cannon /ˈkænən/ 大炮 - large gun
  - The fort still displays an old cannon.

### lather loathe
- lather /ˈlæðər/ 肥皂泡；泡沫 - foam
  - The soap makes a rich lather.
- loathe /ləʊð/ 厌恶 - hate strongly
  - I loathe being interrupted while working.

### obvious oblivious
- obvious /ˈɒbvɪəs/ 明显的 - clear
  - It was obvious that he was tired.
- oblivious /əˈblɪviəs/ 没注意到的；不知情的 - unaware
  - She seemed oblivious to the noise around her.

### well-being welfare farewell
- well-being /ˌwel ˈbiːɪŋ/ 幸福；健康；安乐 - health and happiness
  - Exercise is important for mental well-being.
- welfare /ˈwelfeə(r)/ 福利；福祉 - well-being / social support
  - The charity works to improve child welfare.
- farewell /ˌfeəˈwel/ 告别；临别的 - goodbye
  - They held a farewell dinner for their teacher.

### hijab jihad
- hijab /hɪˈdʒɑːb/ 头巾；穆斯林女性头巾 - headscarf
  - She chose a blue hijab for the ceremony.
- jihad /dʒɪˈhɑːd/ 圣战；奋斗，努力 - struggle
  - The term jihad is often misunderstood in media reports.

### enforce reinforce
- enforce /ɪnˈfɔːrs/ 执行；实施；强制实行 - make obey
  - Police must enforce the law fairly.
- reinforce /ˌriːɪnˈfɔːrs/ 加强；增援；加固 - strengthen
  - Steel bars reinforce the concrete wall.

### stern discern stubborn
- stern /stɜːrn/ 严厉的；冷峻的 - severe
  - The teacher gave him a stern look.
- discern /dɪˈsɜːrn/ 辨别；看出；觉察 - detect
  - I could barely discern a figure in the fog.
- stubborn /ˈstʌbərn/ 固执的；顽强的 - obstinate
  - She remained stubborn despite all advice.

### envision vision
- envision /ɪnˈvɪʒn/ 想象；设想；展望 - imagine
  - She envisioned a different future for the company.
- vision /ˈvɪʒn/ 视力；视觉；想象中的景象 - sight / mental image
  - The plan began as a simple vision.

### rude crude
- rude /ruːd/ 粗鲁的；无礼的 - impolite
  - It was rude to interrupt her.
- crude /kruːd/ 粗糙的；粗略的；天然的 - rough / unrefined
  - They made a crude sketch of the machine.

### premier premiere
- premier /ˈpriːmiər/ 首要的；总理 - first / leading
  - It is one of the country's premier universities.
- premiere /ˈpremieə(r)/ 首映；首演 - first public performance
  - The film's premiere drew a large crowd.

### stump stumble tumble
- stump /stʌmp/ 树桩；残余部分；使困惑 - tree stump / obstacle
  - We sat on a stump beside the trail.
  - # 同源提示：这里可理解为“障碍物”
- stumble /ˈstʌmbəl/ 绊了一下；跌跌撞撞地走；结巴 - trip / lose balance
  - He stumbled on the step but did not fall.
  - # 同源提示：是“遇到障碍时的反应”
- tumble /ˈtʌmbəl/ 跌倒；翻滚；突然掉下 - fall / roll
  - The child tumbled down the hill.
  - # 词源核心可联想为：转、翻、滚

### accumulate cumulate
- accumulate /əˈkjuːmjəleɪt/ 积累；堆积 - build up gradually
  - Dust accumulated on the shelves over the winter.
  - # 强调“慢慢积累的过程”
- cumulate /ˈkjuːmjəleɪt/ 累积；堆积 - gather into a mass
  - The figures cumulate into a significant total.
  - # 更强调“积完之后的总量 / 堆”

### award reward
- award /əˈwɔːrd/ 奖项；授予 - official prize / grant
  - She won an award for best director.
  - # 正式授予的奖项，多用于比赛、评选、官方场合
- reward /rɪˈwɔːrd/ 奖励；回报 - return for effort or help
  - The company offered a reward for information.
  - # 作为回报的奖励，因为做了某事、完成任务或提供帮助

### enact intact
- enact /ɪˈnækt/ 制定（法律）；扮演；表演 - make into law / perform
  - Parliament enacted the new policy last year.
- intact /ɪnˈtækt/ 完整无损的 - whole / undamaged
  - The documents were found intact after the fire.

### foul foe woe
- foul /faʊl/ 肮脏的；犯规的；恶劣的 - dirty / unfair
  - The player was sent off for a foul tackle.
- foe /fəʊ/ 敌人 - enemy
  - He saw himself as a foe of corruption.
- woe /wəʊ/ 悲哀；苦难 - sorrow / misery
  - The poem is full of grief and woe.

### exert excerpt
- exert /ɪɡˈzɜːrt/ 运用；施加（力量、影响等） - apply
  - You will need to exert more pressure to open it.
- excerpt /ˈeksɜːrpt/ 摘录；节选 - passage
  - The magazine published an excerpt from her memoir.

### whore chore chord chorus
- whore /hɔːr/ 娼妓；妓女（带强烈贬义） - prostitute
  - The term is highly offensive in many contexts.
- chore /tʃɔːr/ 家务；杂事 - routine task
  - Washing dishes is my least favorite chore.
- chord /kɔːrd/ 和弦 - group of musical notes
  - He played a minor chord on the piano.
- chorus /ˈkɔːrəs/ 合唱；副歌 - group singing / refrain
  - Everyone joined in the chorus.

### prostitute prostate
- prostitute /ˈprɒstɪtjuːt/ 妓女；卖淫者 - sex worker
  - The novel tells the story of a former prostitute.
- prostate /ˈprɒsteɪt/ 前列腺 - male gland
  - The doctor examined his prostate.

### bunch bundle
- bunch /bʌntʃ/ 串；束；群 - group tied or gathered together
  - She bought a bunch of grapes.
- bundle /ˈbʌndl/ 捆；包；一批东西 - package / collection
  - He carried a bundle of old clothes.

### clump lump
- clump /klʌmp/ 丛；团；聚成一团 - cluster
  - Wet leaves lay in clumps on the ground.
  - # many things together：很多小东西凑成一团
- lump /lʌmp/ 块；肿块；把……归并 - solid mass
  - There was a lump of sugar in the bowl.
  - # one solid mass：一个独立的块

### civil civic
- civil /ˈsɪvəl/ 公民的；民事的；文明的 - relating to citizens / polite
  - They finally had a civil conversation.
- civic /ˈsɪvɪk/ 城市的；市民的；公民事务的 - relating to a city or citizenship
  - She is active in civic affairs.

### predator prey
- predator /ˈpredətər/ 捕食者；掠夺者 - hunter
  - Wolves are natural predators.
- prey /preɪ/ 猎物；受害者 - animal hunted / victim
  - The eagle swooped down on its prey.

### sever severe revere
- sever /ˈsevər/ 切断；断绝 - cut off
  - The accident severed a power line.
- severe /sɪˈvɪr/ 严重的；严厉的 - serious / harsh
  - The storm caused severe damage.
- revere /rɪˈvɪr/ 尊敬；崇敬 - respect deeply
  - Many people revere her as a national hero.

### schematic diagram
- schematic /skiˈmætɪk/ 示意性的；概要的；电路图的 - simplified / symbolic
  - The manual includes a schematic of the control system.
- diagram /ˈdaɪəɡræm/ 图表；示意图 - visual representation
  - The teacher drew a diagram on the board.

### toggle topple
- toggle /ˈtɒɡəl/ 切换；开关 - switch
  - Click here to toggle dark mode.
- topple /ˈtɒpəl/ 倾倒；推翻 - fall over
  - The statue toppled in the earthquake.

### tramp trample
- tramp /træmp/ 沉重地走；流浪者 - walk heavily / vagabond
  - We tramped through the muddy field.
- trample /ˈtræmpəl/ 踩踏；蹂躏 - tread on
  - Be careful not to trample the flowers.

### tumble stumble
- tumble /ˈtʌmbəl/ 跌倒；翻滚；突然掉下 - fall / roll
  - He tumbled down the stairs.
- stumble /ˈstʌmbəl/ 绊了一下；跌跌撞撞地走 - trip / lose balance
  - She stumbled over a rock on the path.

### impair impart implant
- impair /ɪmˈpeər/ 损害；削弱 - damage
  - Smoking can impair lung function.
- impart /ɪmˈpɑːrt/ 传授；给予；告知 - pass on
  - Good teachers impart confidence as well as knowledge.
- implant /ɪmˈplɑːnt/ 植入；灌输；植入物 - place into / insert
  - Doctors implanted a small device in his chest.

### taint stain
- taint /teɪnt/ 污染；玷污 - contaminate
  * The scandal tainted his reputation.
- stain /steɪn/ 污渍；染污 - mark
  * There was a coffee stain on my shirt.

### passive passion compassion
- passive /ˈpæsɪv/ 被动的；消极的 - inactive
  * He remained passive during the discussion.
- passion /ˈpæʃən/ 激情；热爱 - enthusiasm
  * She has a passion for music.
- compassion /kəmˈpæʃən/ 同情；怜悯 - sympathy
  * The nurse treated patients with compassion.

### overlay overlap underlie
- overlay /ˌəʊvəˈleɪ/ 覆盖；叠加 - cover
  * A transparent map was overlaid on the screen.
- overlap /ˌəʊvəˈlæp/ 重叠；部分相同 - intersect
  * Their work schedules overlap.
- underlie /ˌʌndəˈlaɪ/ 构成……的基础；位于下面 - support
  * Trust underlies a good relationship.
