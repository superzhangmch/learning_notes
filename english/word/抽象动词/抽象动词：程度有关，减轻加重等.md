...
- regress 退化，倒退
  - Without practice, skills may regress. （不练习技能就会退步）
...
- **increasing** /ɪnˈkriː.sɪŋ/ 不断增长的，越来越多的 常用度：10
  *There is increasing pressure on governments to act on climate change.*
- **growing** /ˈɡrəʊ.ɪŋ/ 增加的，不断发展的 常用度：9
  *She felt a growing sense of unease.*
- **rising** /ˈraɪ.zɪŋ/ 上升的，增加的 常用度：8
  *Rising fuel costs are affecting transportation companies.*
- **mounting** /ˈmaʊn.tɪŋ/ 日益增加的，不断加剧的（用于修饰问题、压力、恐惧等）常用度：7
  *There is mounting concern over inflation.*
- **escalating** /ˈes.kə.leɪ.tɪŋ/ 逐步升级的，加剧的 常用度：7
  *The escalating conflict drew international attention.*
- **intensifying** /ɪnˈten.sɪ.faɪ.ɪŋ/ 加强的，愈发剧烈的 常用度：6
  *The storm is intensifying as it approaches the coast.*
- **compounding** /kəmˈpaʊn.dɪŋ/ 使恶化，加重 常用度：5
  *His refusal to apologize is compounding the tension.*
- **aggravating** /ˈæɡ.rə.veɪ.tɪŋ/ 加重的，使更严重的 常用度：6
  *The delays are aggravating an already difficult situation.*
- **building up** /ˈbɪl.dɪŋ ʌp/ 累积，加剧 常用度：7
  *Stress had been building up for weeks.*
- **snowballing** /ˈsnəʊ.bɔː.lɪŋ/ 滚雪球般增加的 常用度：5
  *The company's problems are snowballing out of control.*
