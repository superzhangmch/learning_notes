...
| 单词                         | 中文含义             | 使用场景 / 示例                               |
| -------------------------- | ---------------- | --------------------------------------- |
| **fake**                   | 假的，伪造的           | fake news, fake ID                      |
| **false**                  | 错误的，不真实的         | false statement, false alarm            |
| **phony** / **phoney** (英) | 虚伪的，假冒的（美式更常用）   | a phony smile, a phony doctor           |
| **bogus**                  | 假的，伪造的（书面/正式）    | a bogus claim, bogus passport           |
| **forged**                 | 伪造的（尤指文件、签名）     | forged signature, forged documents      |
| **counterfeit**            | 伪造的（尤指钱、商品）      | counterfeit money, counterfeit goods    |
| **fabricated**             | 捏造的（虚构出来的）       | fabricated story, fabricated evidence   |
| **fictitious**             | 虚构的（小说、虚拟人物）     | a fictitious name, a fictitious address |
| **deceptive**              | 有欺骗性的            | deceptive appearance, deceptive ad      |
| **pretend** *(adj.)*       | 假装的，做戏的（较少用作形容词） | a pretend game, pretend play            |

常见名词（n.）

| 单词              | 中文含义   | 示例                               |
| --------------- | ------ | -------------------------------- |
| **lie**         | 谎言     | That was a lie.                  |
| **fraud**       | 欺诈，骗局  | He committed fraud.              |
| **scam**        | 骗局，诈骗  | It's a scam.                     |
| **hoax**        | 恶作剧，骗局 | a bomb hoax, a viral hoax        |
| **deception**   | 欺骗     | The whole thing was a deception. |
| **forgery**     | 伪造品    | He was arrested for forgery.     |
| **counterfeit** | 伪造品    | This is a counterfeit.           |

动词

| 单词              | 中文含义      | 示例                               |
| --------------- | --------- | -------------------------------- |
| **fake**        | 伪造，假装     | He faked his illness.            |
| **forge**       | 伪造（尤指签名）  | He forged the signature.         |
| **counterfeit** | 伪造（金钱、文件） | They counterfeited the currency. |
| **fabricate**   | 捏造        | She fabricated the whole story.  |
| **deceive**     | 欺骗        | He deceived everyone.            |
| **pretend**     | 假装        | He pretended to be sick.         |
