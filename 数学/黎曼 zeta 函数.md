...
('calc', (0.5+14.134725141j), mpc(real='9.161612314364e-11', imag='-5.754826484396e-10')) # match
__
macll.py:99: RuntimeWarning: invalid value encountered in divide
  zeta_s = gamma(1-s) / (2*cmath.pi*1j) * x
('should_be', 2, (nan+nanj))
('calc', 2, mpf('1.644934066848')) # 
__
('should_be', 2.00001, (1.6581786099366211+3.665468959566902e-10j))
('calc', 2.00001, mpf('1.644924691471')) # 基本match
__
('should_be', 2.000001, (1.777473800519907+3.9043379294062815e-09j))
('calc', 2.000001, mpf('1.644933129297')) # 不大match
__
...
('calc', (2+2j), mpc(real='0.8673518296346', imag='-0.2751272388086')) # match
__
('should_be', (-20+20j), (7.014837841351859e+22-1.2214195900731435e+23j)) 
('calc', (-20+20j), mpc(real='295261595076.0', imag='167640361564.0')) # bad
```
