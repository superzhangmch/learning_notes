...
### relative vs related
- relative /ˈrelətɪv/ 相对的；比较而言的（也可作名词表示“亲属”） - comparative
  - The price is low relative to the quality.
- related /rɪˈleɪtɪd/ 相关的；有联系的 - connected
  - These two issues are closely related.

### emulate simulate
- emulate /ˈemjuleɪt/ 效仿；努力赶上或媲美 - imitate and match; 侧重以假乱真
  - Young musicians often emulate their favorite performers.
- simulate /ˈsɪmjuleɪt/ 模拟；仿真；假装 - imitate artificially; 侧重相似(similar)
  - The software simulates real flight conditions.

### historic historical
- historic /hɪˈstɒrɪk/ 历史上重要的；具有重大意义的 - important in history
  - The election was a historic moment for the country.
- historical /hɪˈstɒrɪkəl/ 与历史有关的；基于史实的 - related to history
  - She spent years studying historical records.
