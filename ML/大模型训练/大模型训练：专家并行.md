...
- 支持 fp8/fp16 低精度操作
  - 这样无疑降低了all-to-all 的通信量
  - 这样无疑降低了all-to-all 的通信量
  - 据 deepseek-v3 paper，它的 fp8 精度训练范式，天然使得 MOE 层就是 fp8 in，fp16 out。
    - 而 deepEP 的 github 库里说：
    > And we follow the **DeepSeek-V3/R1 pretraining** setting (4096 tokens per batch, 7168 hidden, top-4 groups, top-8 experts, **FP8 dispatching and BF16 combining**).
    >
